...
def _assert_imputed_data(
    ...
    expected_means = [
        (0.47049668850999954, 0.4518556049811879),
        (0.47229553901283766, 0.44517428613744364),
        (0.47138837843767245, 0.48235300190580915),
        (0.47045684861435155, 0.47648397134676956),
    ]
...
def _assert_imp_quality(evaluator: Evaluator) -> None:
    expected_results = {
        "rmse": [0.1798457867152958, 0.1844441231270879, 0.11678506916100821, 0.12679801086028014],
        "nrmse": [0.5013142322084387, 0.5344403670220056, 0.32373838262028415, 0.35515430429853717],
        "sliced-ws": [0.07942971555749821, 0.09062618125492293, 0.045155291564512305, 0.0558995513120347],
    }
...
def _assert_fed_prediction(evaluator: Evaluator) -> None:
    expected_global = {
        ...
        "auc": 0.9790159982467674,
        "prc": 0.9533488935842966,
    }
