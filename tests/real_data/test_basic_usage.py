...
def _assert_imputed_data(
    ...
    expected_means = [
        (0.47049669, 0.45157606),
        (0.47229554, 0.44377668),
        (0.47138838, 0.48236372),
        (0.47045685, 0.47623707),
    ]
...
def _assert_imp_quality(evaluator: Evaluator) -> None:
    expected_results = {
        "rmse": [0.18108324, 0.18745715, 0.11706313, 0.12649426],
        "nrmse": [0.50476358, 0.54317083, 0.32450918, 0.35430351],
        "sliced-ws": [0.08009951, 0.09351452, 0.0454158, 0.05578751],
    }
...
def _assert_fed_prediction(evaluator: Evaluator) -> None:
    expected_global = {
        ...
        "auc": 0.9788516326977865,
        "prc": 0.9529250675855315,
    }
